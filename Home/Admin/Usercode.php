...
if(isset($_POST['add_user']))
{
	...
	$query="INSERT INTO registered_user (ID,prn,Name,email,phone_no,Status) VALUES('$ID','$prn','$Name','$email','$phone_no','$Status')";//parameters(prn,Name..) are nothing but database column name
