  ...
  <div class="wrapper">
              ...
              <div id="star" class="box">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="edit-profile.php"><i class="fa fa-user"></i> Edit Profile</a></li><br><br>
                    <li class="active"><a href="index.php"><i class="fa fa-address-card-o"></i> My Applications</a></li><br><br>
                  <li><a href="../jobs.php"><i class="fa fa-list-ul"></i> Active Drives</a></li><br><br>
                    <li><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li><br><br>
                    <li><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li><br><br>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 campus connect</a>.</strong> All rights
        reserved.
      </div>
    </footer>
